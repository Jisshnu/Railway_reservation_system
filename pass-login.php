...
<?php
    ...
    if(isset($_POST['pass_login']))
    {
      ...
      $stmt=$mysqli->prepare("SELECT pass_email ,pass_pwd FROM jiss_passenger WHERE pass_email=? and pass_pwd=? ");//sql to log in user
          ...
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header">
                ...
                <span class="splash-description">Login Here</span>
              </div>
              <div class="card-body">
